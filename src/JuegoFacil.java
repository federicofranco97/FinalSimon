...
public class JuegoFacil extends javax.swing.JFrame {
     ...
     * 
     * Idealmente repite la secuencia anterior pero falla
     */
    public void acierto(){
    ...
    public void repetirSecuencia(){
        ...
        t2.addActionListener((a3->{
            switch(Integer.parseInt(respuesta.get(frame.get()))){
                case 0: btn1.setBackground(Color.white);break;
                case 1: btn2.setBackground(Color.white);break;
                case 2: btn3.setBackground(Color.white);break;
                case 3: btn4.setBackground(Color.white);break;
            } 
            frame.incrementAndGet();
            if (frame.get() >= respuesta.size()) {
                timer.stop();   
            }
            t2.stop();
        }));
        timer.addActionListener((e) -> {
            ...
            switch(Integer.parseInt(respuesta.get(frame.get()))){
                case 0: btn1.setBackground(Color.RED);break;
                case 1: btn2.setBackground(Color.GREEN);break;
                case 2: btn3.setBackground(Color.BLUE);break;
                case 3: btn4.setBackground(Color.YELLOW);break;
            }
            t2.start();           
